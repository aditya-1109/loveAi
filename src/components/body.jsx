...
export default function Body() {
  ...
  const { id } = useParams()
  const [message, setMessages] = useState({ heading: "Happy Birthday cute girl", name: "Amisha 💖", "message": "I am sorry i got little late and could not give you any realistic gift but i hope you will like this, a cute page for a cute girl" })
